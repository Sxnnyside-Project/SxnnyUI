...
extension UIImage {
    /// Fixes the orientation of the image based on its `imageOrientation` property.
    /// - Returns: A new `UIImage` instance with the corrected orientation, or the original image if the orientation cannot be fixed.
